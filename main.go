...
func main() {
	...
	accountService := service.NewAcccountService(accountRepository)
	accountHanler := handler.NewAccountHandler(accountService)
	...
	router.HandleFunc("/customers/{customerID}/accounts", accountHanler.GetAccounts).Methods(http.MethodGet)
	router.HandleFunc("/customers/{customerID}/accounts", accountHanler.NewAccount).Methods(http.MethodPost)
